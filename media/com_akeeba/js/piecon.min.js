...
if(!c||!g){var a;a:{a=document.getElementsByTagName("link");for(var e=0,f=a.length;e<f;e++)if("icon"===a[e].getAttribute("rel")||"shortcut icon"===a[e].getAttribute("rel")){a=a[e];break a}a=!1}c=g=a?a.getAttribute("href"):"/favicon.ico"}if(!isNaN(parseFloat(b))&&isFinite(b))!n().getContext||q||r||!0===k.fallback?document.title=0<b?"("+b+"%) "+d:d:("force"===k.fallback&&(document.title=0<b?"("+b+"%) "+d:d),a=n(),e=a.getContext("2d"),b=b||0,e&&(e.clearRect(0,0,a.width,a.height),e.beginPath(),e.moveTo(a.width/
