...
akeeba.Tooltip.onMouseEnter=function(a){if(a.target.hasAttribute("data-content")){var b;a.target.hasAttribute("data-tooltip-uuid")?b=a.target.getAttribute("data-tooltip-uuid"):(b=Math.uuid(),a.target.setAttribute("data-tooltip-uuid",b));if(null==document.getElementById("akeeba-tooltip-"+b)){var c=a.target.getAttribute("data-position")||"center bottom",d=c.split(" ")[0],e=c.split(" ")[1],f=document.createElement("div");f.className="popover akeeba-bootstrap-popover";f.id="akeeba-tooltip-"+b;f.style.display=
"block";f.className+=" "+c;f.insertAdjacentHTML("afterbegin",'<div class="arrow"></div>');b=document.createElement("div");b.className="popover-inner";f.appendChild(b);a.target.hasAttribute("data-original-title")&&(c=document.createElement("h3"),c.className="popover-title",c.innerHTML=a.target.getAttribute("data-original-title"),b.appendChild(c));c=document.createElement("div");c.className="popover-content";c.innerHTML=a.target.getAttribute("data-content");b.appendChild(c);document.body.appendChild(f);
