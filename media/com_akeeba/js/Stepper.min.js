...
var c="label-success",e;document.querySelector(b.options.steps).innerHTML="";for(var d=0;d<this.domains.length;d++){e=this.domains[d];var f=document.createElement("div");f.className="label";f.textContent=e[1];akeeba.System.data.set(f,"domain",e[0]);document.querySelector(b.options.steps).appendChild(f);e[0]==a?(c="",e="label-info"):e=c;f.className+=" "+e}};this.start=function(){this.options.onBeforeStart(d);d.data.ajax="start";akeeba.Ajax.ajax("index.php?option=com_akeeba&tmpl=component&"+this.options.pollingUrl,
d)};this.step=function(a){this.options.onBeforeStep(d,a);h();g();d.data.ajax="step";akeeba.Ajax.ajax("index.php?option=com_akeeba&tmpl=component&"+this.options.pollingUrl,d)};this.complete=function(a){h();this.options.onComplete(a)}}; //# sourceMappingURL=Stepper.min.map
