...
akeeba.System.iframeCallback=function(){var a=(akeeba.System.params.iFrame.contentDocument?akeeba.System.params.iFrame.contentDocument:akeeba.System.params.iFrame.contentWindow.document).body.innerHTML;akeeba.System.params.iFrame.parentNode.removeChild(akeeba.System.params.iFrame);akeeba.System.params.iFrame=null;var b=a.indexOf("###");if(-1==b)a="Invalid AJAX data: "+a,null==akeeba.System.params.iFrameCallbackError?null!=akeeba.System.params.errorCallback&&akeeba.System.params.errorCallback(a):akeeba.System.params.iFrameCallbackError(a);
else{0!=b&&(a.substr(0,b),a=a.substr(b));a=a.substr(3);b=a.lastIndexOf("###");a=a.substr(0,b);try{var c=JSON.parse(a)}catch(d){a=d.message+"\n<br/>\n<pre>\n"+a+"\n</pre>";null==akeeba.System.params.iFrameCallbackError?null!=akeeba.System.params.errorCallback&&akeeba.System.params.errorCallback(a):akeeba.System.params.iFrameCallbackError(a);return}akeeba.System.params.iFrameCallbackSuccess(c)}};
akeeba.System.doAjax=function(a,b,c,d,e){if(akeeba.System.params.useIFrame)akeeba.System.doIframeCall(a,b,c);else{null==d&&(d=!0);var f=(new Date).getTime()/1E3,g=parseInt(f,10);a._cacheBustingJunk=Math.round(1E3*(f-g))/1E3;null==e&&(e=6E5);a={type:"POST",url:akeeba.System.params.AjaxURL,cache:!1,data:a,timeout:e,success:function(a){var e=a.indexOf("###");if(-1==e)a=akeeba.System.sanitizeErrorMessage(a),a="Invalid AJAX data: "+a,null==c?null!=akeeba.System.params.errorCallback&&akeeba.System.params.errorCallback(a):
c(a);else{0!=e&&(a.substr(0,e),a=a.substr(e));a=a.substr(3);e=a.lastIndexOf("###");a=a.substr(0,e);try{var d=JSON.parse(a)}catch(h){a=akeeba.System.sanitizeErrorMessage(a);a=h.message+"\n<br/>\n<pre>\n"+a+"\n</pre>";null==c?null!=akeeba.System.params.errorCallback&&akeeba.System.params.errorCallback(a):c(a);return}b(d)}},error:function(a,b,e){e=a.responseText?a.responseText:"";var d="<strong>AJAX Loading Error</strong><br/>HTTP Status: "+a.status+" ("+a.statusText+")<br/>",d=d+"Internal status: "+
...
akeeba.System.data=function(){var a=0,b={};return{set:function(c,d,e){if(c.dataset)c.dataset[d]=e,null==e&&delete c.dataset[d];else{var f;void 0===c.myCustomDataTag&&(f=a++,c.myCustomDataTag=f);"undefined"==typeof b[f]&&(b[f]={});b[f][d]=e;var g="data-"+d.split(/(?=[A-Z])/).join("-").toLowerCase();c.setAttribute&&c.setAttribute(g,e);if(null==e)try{delete b[f][d],c.removeAttribute(g)}catch(k){b[f][d]=null}}},get:function(a,d,e){if(a.dataset)return"undefined"==typeof a.dataset[d]&&(a.dataset[d]=e),
a.dataset[d];"undefined"==typeof e&&(e=null);"undefined"==typeof b[a.myCustomDataTag]&&(b[a.myCustomDataTag]={});var c="data-"+d.split(/(?=[A-Z])/).join("-").toLowerCase();"undefined"!==typeof a[c]&&(b[a.myCustomDataTag][d]=a[c]);"undefined"==typeof b[a.myCustomDataTag][d]&&this.set(a,d,e);return b[a.myCustomDataTag][d]}}}();
...
akeeba.System.triggerEvent=function(a,b){if("undefined"!=typeof a&&null!==a&&("string"===typeof a&&(a=document.getElementById(a)),"object"==typeof a&&a instanceof Element))if(document.fireEvent&&"undefined"==typeof window.Event)a.fireEvent("on"+b);else{var c=document.createEvent("HTMLEvents");c.initEvent(b,!0,!0);a.dispatchEvent(c)}};
